...
parking_address = ['A01', u'명륜역', u'부산광역시 동래구 명륜동 2-2', #35.213735, 129.080503
	'A02', u'사상역', u'부산광역시 사상구 괘법동 429', #35.162266, 128.988617
	'A03', u'동래역', u'부산광역시 동래구 명륜동 654-2', #35.207438, 129.078484
	'A04', u'온천장역', u'부산광역시 동래구 온천1동 1750-1', #35.213530, 129.080126
	'A05', u'부산대남측', u'부산광역시 금정구 부곡동 441-27', #35.228230, 129.089236
	'A06', u'부산대북측', u'부산광역시 금정구 부곡동 399', #35.231672, 129.089029
	'A07', u'장전역', u'부산광역시 금정구 장전1동 242', #35.239197, 129.088424
	'A08', u'구서역', u'부산광역시 금정구 구서1동 475', #35.245587, 129.091250
	'A09', u'남산역', u'부산광역시 금정구 남산동 893-8', #35.265426, 129.092845
	'A10', u'노포역', u'부산광역시 금정구 노포동', #35.283269, 129.095090
	'A11', u'하단역', u'부산광역시 사하구 하단1동 599', #35.104601, 128.964474
	'A12', u'학장천', u'부산광역시 사상구 주례동 201-4', #35.148666, 129.001273
	'A14', u'장산역2', u'부산광역시 해운대구 좌동 1479-4', #35.169152, 129.177358
	'A15', u'장산역', u'부산광역시 해운대구 좌동 1467-1', #35.170445, 129.175992
	'A16', u'해운대광장', u'부산광역시 해운대구 우동 620-25', #35.159073, 129.159332
	'A17', u'수변공원', u'부산광역시 수영구 민락동', #35.154869, 129.131358
	'A18', u'광안해수월드옆', u'부산광역시 수영구 민락동 110-15', #35.156325, 129.134126
	'A22', u'중동역 주차장', u'부산광역시 해운대구 중동 1758', #35.167051, 129.170377
	'A23', u'동백사거리 주차장', u'부산광역시 해운대구 우1동 1437', #35.157585, 129.151627
	]
...
def get_parking_address(parking_name):
	pos = 0
...
#			print item.tag
	...
	for element in root.iter("item"):
		...
		max_capacity = element.findtext("maxcnt")
...
#		ET.dump(parking_event)
		...
		parking_event.write("output-master-"+str(parking_num)+".xml", encoding="utf-8", xml_declaration=True)
